...
export default function App() {
    const { isLoading, isLoggedIn } = useGloabalContext();
            ...
            <ScrollView contentContainerStyle={{ height: '100%' }}>
                <View className='w-full justify-center items-center h-full px-4'>
                    ...
                    <View className='relative mt-5'>
                        <Text className='text-3xl text-white font-bold text-center'>Discover Endless Possibilites{' '} <Text className='text-secondary-200'>Aora</Text></Text>
